...
<head>
    ...
    <link href="{{ asset("css/materialize.css?v=".env('APP_VERSION')) }}" type="text/css" rel="stylesheet" media="screen,projection"/>
    <link href="{{ asset("css/style.css?v=".env('APP_VERSION')) }}" type="text/css" rel="stylesheet" media="screen,projection"/>
    <link href="{{ asset("css/print.css?v=".env('APP_VERSION')) }}" type="text/css" rel="stylesheet" media="print"/>
</head>
<body>
...
<script src="{{ asset("js/init.js?v=".env('APP_VERSION')) }}"></script>
<script src="{{ asset("js/submitter.js?v=".env('APP_VERSION')) }}"></script>
