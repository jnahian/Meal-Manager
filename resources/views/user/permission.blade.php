                ...
                <div class="card-content">
                    ...
                    <div class="row">
                        <div class="input-field col m4 s12">
                            <input type="text" name="date_from" id="date_from" class="datepicker validate" readonly
                                   value="{{ $user->date ? $user->date->format("Y-m-d") : "" }}">
                            <label for="date">Date From <span class="red-text text-lighten-3">*</span></label>
                        </div>
                        <div class="input-field col m4 s12">
                            <input type="text" name="date_to" id="date_to" class="datepicker validate" readonly
                                   value="{{ $user->date ? $user->date->format("Y-m-d") : "" }}">
